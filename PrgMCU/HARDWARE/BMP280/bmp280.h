...
//IO方向设置
#define SDA_IN()   {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=8<<12;} //{GPIOC->CRH&=0XFFFF0FFF;GPIOC->CRH|=8<<12;}
#define SDA_OUT()  {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=3<<12;} //{GPIOC->CRH&=0XFFFF0FFF;GPIOC->CRH|=3<<12;}

//IO操作函数	 
#define IIC_SCL    PBout(10) //PCout(12)                                                   	//SCL 
#define IIC_SDA    PBout(11) //PCout(11)                                                   	//SDA	 
#define READ_SDA   PBin(11) //PCin(11)                                                    	//输入SDA 
