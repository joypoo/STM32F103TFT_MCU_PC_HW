...
void Draw_SolidCircle(u16 x0,u16 y0,u8 r,u16 color);//在指定位置画一个实心圆
...
void LCD_ShowIntNumLeadingZeros(u16 x,u16 y,u16 num,u8 len,u16 fc,u16 bc,u8 sizey);//显示整数变量,带前导0
...
void LCD_ShowHEX(u16 x,u16 y,char num, u16 fc,u16 bc,u8 sizey); //显示HEX字符
//画笔颜色
#define WHITE         	 0xFFFF
#define BLACK         	 0x0000	  
#define BLUE           	 0x001F  
